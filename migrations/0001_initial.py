...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('logger_ng_loggedmessage', (
            ...
            ('backend', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ...
            ('status', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
    ...
    models = {
        ...
        'logger_ng.loggedmessage': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
