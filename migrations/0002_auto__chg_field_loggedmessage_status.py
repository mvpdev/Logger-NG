...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LoggedMessage.status'
        db.alter_column('logger_ng_loggedmessage', 'status', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'LoggedMessage.status'
        db.alter_column('logger_ng_loggedmessage', 'status', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True))
